    ...
    var a, t = function (e, s) {
            ...
            if (v.version = '3.1.0', v.params = s, v.classNames = [], 'undefined' != typeof a && 'undefined' != typeof Dom7 && (a = Dom7), ('undefined' != typeof a || (a = 'undefined' == typeof Dom7 ? window.Dom7 || window.Zepto || window.jQuery : Dom7)) && (v.$ = a, v.container = a(e), 0 !== v.container.length)) {
                ...
                return v.callPlugins = function (e) {
                    ...
                    ].join(' ')).removeAttr('style').removeAttr('data-swiper-column').removeAttr('data-swiper-row'), v.paginationContainer && v.paginationContainer.length && v.paginationContainer.removeClass(v.params.paginationHiddenClass), v.bullets && v.bullets.length && v.bullets.removeClass(v.params.bulletActiveClass), v.params.prevButton && a(v.params.prevButton).removeClass(v.params.buttonDisabledClass), v.params.nextButton && a(v.params.nextButton).removeClass(v.params.buttonDisabledClass), v.params.scrollbar && v.scrollbar && (v.scrollbar.track && v.scrollbar.track.length && v.scrollbar.track.removeAttr('style'), v.scrollbar.drag && v.scrollbar.drag.length && v.scrollbar.drag.removeAttr('style'));
...
'use strict';
module.exports = window.Swiper || module.exports;;    //# sourceMappingURL=maps/swiper.jquery.min.js.map
