            ...
            if (w.version = '3.1.0', w.params = s, w.classNames = [], 'undefined' != typeof a && 'undefined' != typeof r && (a = r), ('undefined' != typeof a || (a = 'undefined' == typeof r ? window.Dom7 || window.Zepto || window.jQuery : r)) && (w.$ = a, w.container = a(e), 0 !== w.container.length)) {
                ...
                w.container[0].swiper = w, w.container.data('swiper', w), w.classNames.push('swiper-container-' + w.params.direction), w.params.freeMode && w.classNames.push('swiper-container-free-mode'), w.support.flexbox || (w.classNames.push('swiper-container-no-flexbox'), w.params.slidesPerColumn = 1), (w.params.parallax || w.params.watchSlidesVisibility) && (w.params.watchSlidesProgress = !0), [
                    ...
                    for (e = 0; e < w.slides.length; e++) {
                        ...
                        'none' !== c.css('display') && ('auto' === w.params.slidesPerView ? (l = i() ? c.outerWidth(!0) : c.outerHeight(!0), w.params.roundLengths && (l = n(l))) : (l = (w.size - (w.params.slidesPerView - 1) * a) / w.params.slidesPerView, w.params.roundLengths && (l = n(l)), i() ? w.slides[e].style.width = l + 'px' : w.slides[e].style.height = l + 'px'), w.slides[e].swiperSlideSize = l, w.slidesSizesGrid.push(l), w.params.centeredSlides ? (t = t + l / 2 + r / 2 + a, 0 === e && (t = t - w.size / 2 - a), Math.abs(t) < 0.001 && (t = 0), s % w.params.slidesPerGroup === 0 && w.snapGrid.push(t), w.slidesGrid.push(t)) : (s % w.params.slidesPerGroup === 0 && w.snapGrid.push(t), w.slidesGrid.push(t), t = t + l + a), w.virtualSize += l + a, r = l, s++);
                    }
                            ...
                            if (s = w.params.followFinger ? w.rtl ? w.translate : -w.translate : -C, w.params.freeMode) {
                                ...
                                if (w.params.freeModeMomentum) {
                                    if (L.length > 1) {
                                        ...
                                        w.velocity = o / l, w.velocity = w.velocity / 2, Math.abs(w.velocity) < 0.02 && (w.velocity = 0), (l > 150 || new window.Date().getTime() - i.time > 300) && (w.velocity = 0);
                                    } else
                                        w.velocity = 0;
                                    L.length = 0;
                                    var d = 1000 * w.params.freeModeMomentumRatio, p = w.velocity * d, u = w.translate + p;
                                    w.rtl && (u = -u);
...
'use strict';
module.exports = window.Swiper || module.exports;;    //# sourceMappingURL=maps/swiper.min.js.map
