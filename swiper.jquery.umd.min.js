...
!function (e, a) {
    ...
    module.exports = a(require('jquery')) || module.exports; : 'object' == typeof exports ? module.exports = a(require('jquery')) : e.Swiper = a(e.jQuery);
}(this, function (e) {
    'use strict';
    function a(e) {
    ...
    var t = function (a, s) {
        ...
        if (v.version = '3.1.0', v.params = s, v.classNames = [], 'undefined' != typeof e && 'undefined' != typeof Dom7 && (e = Dom7), ('undefined' != typeof e || (e = 'undefined' == typeof Dom7 ? window.Dom7 || window.Zepto || window.jQuery : Dom7)) && (v.$ = e, v.container = e(a), 0 !== v.container.length)) {
            ...
            v.container[0].swiper = v, v.container.data('swiper', v), v.classNames.push('swiper-container-' + v.params.direction), v.params.freeMode && v.classNames.push('swiper-container-free-mode'), v.support.flexbox || (v.classNames.push('swiper-container-no-flexbox'), v.params.slidesPerColumn = 1), (v.params.parallax || v.params.watchSlidesVisibility) && (v.params.watchSlidesProgress = !0), [
                'cube',
                'coverflow'
            ].indexOf(v.params.effect) >= 0 && (v.support.transforms3d ? (v.params.watchSlidesProgress = !0, v.classNames.push('swiper-container-3d')) : v.params.effect = 'slide'), 'slide' !== v.params.effect && v.classNames.push('swiper-container-' + v.params.effect), 'cube' === v.params.effect && (v.params.resistanceRatio = 0, v.params.slidesPerView = 1, v.params.slidesPerColumn = 1, v.params.slidesPerGroup = 1, v.params.centeredSlides = !1, v.params.spaceBetween = 0, v.params.virtualTranslate = !0, v.params.setWrapperSize = !1), 'fade' === v.params.effect && (v.params.slidesPerView = 1, v.params.slidesPerColumn = 1, v.params.slidesPerGroup = 1, v.params.watchSlidesProgress = !0, v.params.spaceBetween = 0, 'undefined' == typeof f && (v.params.virtualTranslate = !0)), v.params.grabCursor && v.support.touch && (v.params.grabCursor = !1), v.wrapper = v.container.children('.' + v.params.wrapperClass), v.params.pagination && (v.paginationContainer = e(v.params.pagination), v.params.paginationClickable && v.paginationContainer.addClass('swiper-pagination-clickable')), v.rtl = r() && ('rtl' === v.container[0].dir.toLowerCase() || 'rtl' === v.container.css('direction')), v.rtl && v.classNames.push('swiper-container-rtl'), v.rtl && (v.wrongRTL = '-webkit-box' === v.wrapper.css('display')), v.params.slidesPerColumn > 1 && v.classNames.push('swiper-container-multirow'), v.device.android && v.classNames.push('swiper-container-android'), v.container.addClass(v.classNames.join(' ')), v.translate = 0, v.progress = 0, v.velocity = 0, v.lockSwipeToNext = function () {
                ...
                for (e = 0; e < v.slides.length; e++) {
                    ...
                    'none' !== c.css('display') && ('auto' === v.params.slidesPerView ? (l = r() ? c.outerWidth(!0) : c.outerHeight(!0), v.params.roundLengths && (l = i(l))) : (l = (v.size - (v.params.slidesPerView - 1) * a) / v.params.slidesPerView, v.params.roundLengths && (l = i(l)), r() ? v.slides[e].style.width = l + 'px' : v.slides[e].style.height = l + 'px'), v.slides[e].swiperSlideSize = l, v.slidesSizesGrid.push(l), v.params.centeredSlides ? (t = t + l / 2 + s / 2 + a, 0 === e && (t = t - v.size / 2 - a), Math.abs(t) < 0.001 && (t = 0), n % v.params.slidesPerGroup === 0 && v.snapGrid.push(t), v.slidesGrid.push(t)) : (n % v.params.slidesPerGroup === 0 && v.snapGrid.push(t), v.slidesGrid.push(t), t = t + l + a), v.virtualSize += l + a, s = l, n++);
                }
                ...
                if ('undefined' == typeof e && (e = v.translate || 0), 0 !== v.slides.length) {
                    ...
                    for (var t = 0; t < v.slides.length; t++) {
                        var s = v.slides[t], i = v.params.centeredSlides === !0 ? s.swiperSlideSize / 2 : 0, n = (a - s.swiperSlideOffset - i) / (s.swiperSlideSize + v.params.spaceBetween);
                        if (v.params.watchSlidesVisibility) {
                            var o = -(a - s.swiperSlideOffset - i), l = o + v.slidesSizesGrid[t], p = o >= 0 && o < v.size || l > 0 && l <= v.size || 0 >= o && l >= v.size;
            ...
            window.navigator.pointerEnabled ? w = [
                ...
                if (v.clickedSlide = t, v.clickedIndex = e(t).index(), v.params.slideToClickedSlide && void 0 !== v.clickedIndex && v.clickedIndex !== v.activeIndex) {
                    ...
                    if (v.params.loop)
                        if (i = e(v.clickedSlide).attr('data-swiper-slide-index'), n > v.slides.length - v.params.slidesPerView)
            ...
            var y, b, x, T, S, C, M, P, z, I = 'input, select, textarea, button', k = Date.now(), E = [];
            ...
            if (v.onTouchStart = function (a) {
                    if (a.originalEvent && (a = a.originalEvent), G = 'touchstart' === a.type, G || !('which' in a) || 3 !== a.which) {
                        if (v.params.noSwiping && o(a, '.' + v.params.noSwipingClass))
                            return void (v.allowClick = !0);
                        if (!v.params.swipeHandler || o(a, v.params.swipeHandler)) {
                            if (y = !0, b = !1, T = void 0, L = void 0, v.touches.startX = v.touches.currentX = 'touchstart' === a.type ? a.targetTouches[0].pageX : a.pageX, v.touches.startY = v.touches.currentY = 'touchstart' === a.type ? a.targetTouches[0].pageY : a.pageY, x = Date.now(), v.allowClick = !0, v.updateContainerSize(), v.swipeDirection = void 0, v.params.threshold > 0 && (M = !1), 'touchstart' !== a.type) {
                                var t = !0;
                                e(a.target).is(I) && (t = !1), document.activeElement && e(document.activeElement).is(I) && document.activeElement.blur(), t && a.preventDefault();
                            }
                    ...
                    if (a.originalEvent && (a = a.originalEvent), !(G && 'mousemove' === a.type || a.preventedByNestedSwiper)) {
                        if (v.params.onlyExternal)
                            return v.allowClick = !1, void (y && (v.touches.startX = v.touches.currentX = 'touchmove' === a.type ? a.targetTouches[0].pageX : a.pageX, v.touches.startY = v.touches.currentY = 'touchmove' === a.type ? a.targetTouches[0].pageY : a.pageY, x = Date.now()));
                        if (G && document.activeElement && a.target === document.activeElement && e(a.target).is(I))
                    ...
                    if (a.originalEvent && (a = a.originalEvent), v.emit('onTouchEnd', v, a), y) {
                        ...
                        if (v.allowClick && (v.updateClickedSlide(a), v.emit('onTap', v, a), 300 > s && t - k > 300 && (P && clearTimeout(P), P = setTimeout(function () {
                            ...
                            }, 300)), 300 > s && 300 > t - k && (P && clearTimeout(P), v.emit('onDoubleTap', v, a))), k = Date.now(), setTimeout(function () {
                                v && (v.allowClick = !0);
                        ...
                        if (r = v.params.followFinger ? v.rtl ? v.translate : -v.translate : -S, v.params.freeMode) {
                            ...
                            if (v.params.freeModeMomentum) {
                                if (E.length > 1) {
                                    var i = E.pop(), n = E.pop(), o = i.position - n.position, l = i.time - n.time;
                                    v.velocity = o / l, v.velocity = v.velocity / 2, Math.abs(v.velocity) < 0.02 && (v.velocity = 0), (l > 150 || new window.Date().getTime() - i.time > 300) && (v.velocity = 0);
                                } else
                                    v.velocity = 0;
                                E.length = 0;
                                var p = 1000 * v.params.freeModeMomentumRatio, d = v.velocity * p, u = v.translate + d;
                                v.rtl && (u = -u);
                    ...
                    v.loopedSlides = parseInt(v.params.loopedSlides || v.params.slidesPerView, 10), v.loopedSlides = v.loopedSlides + v.params.loopAdditionalSlides, v.loopedSlides > a.length && (v.loopedSlides = a.length);
                    var t, s = [], r = [];
                    for (a.each(function (t, i) {
                            var n = e(this);
                            t < v.loopedSlides && r.push(i), t < a.length && t >= a.length - v.loopedSlides && s.push(i), n.attr('data-swiper-slide-index', t);
                        }), t = 0; t < r.length; t++)
                        v.wrapper.append(e(r[t].cloneNode(!0)).addClass(v.params.slideDuplicateClass));
                    for (t = s.length - 1; t >= 0; t--)
                        v.wrapper.prepend(e(s[t].cloneNode(!0)).addClass(v.params.slideDuplicateClass));
                        ...
                        setTranslate: function () {
                            for (var a = v.translate, t = r() ? -a + v.width / 2 : -a + v.height / 2, s = r() ? v.params.coverflow.rotate : -v.params.coverflow.rotate, i = v.params.coverflow.depth, n = 0, o = v.slides.length; o > n; n++) {
                                ...
                                if (l.transform(w), l[0].style.zIndex = -Math.abs(Math.round(u)) + 1, v.params.coverflow.slideShadows) {
                                    var y = l.find(r() ? '.swiper-slide-shadow-left' : '.swiper-slide-shadow-top'), b = l.find(r() ? '.swiper-slide-shadow-right' : '.swiper-slide-shadow-bottom');
            ...
            return v.callPlugins = function (e) {
                ...
                v.container.removeClass(v.classNames.join(' ')).removeAttr('style'), v.wrapper.removeAttr('style'), v.slides && v.slides.length && v.slides.removeClass([
                    v.params.slideVisibleClass,
                    v.params.slideActiveClass,
                    v.params.slideNextClass,
                    v.params.slidePrevClass
                ].join(' ')).removeAttr('style').removeAttr('data-swiper-column').removeAttr('data-swiper-row'), v.paginationContainer && v.paginationContainer.length && v.paginationContainer.removeClass(v.params.paginationHiddenClass), v.bullets && v.bullets.length && v.bullets.removeClass(v.params.bulletActiveClass), v.params.prevButton && e(v.params.prevButton).removeClass(v.params.buttonDisabledClass), v.params.nextButton && e(v.params.nextButton).removeClass(v.params.buttonDisabledClass), v.params.scrollbar && v.scrollbar && (v.scrollbar.track && v.scrollbar.track.length && v.scrollbar.track.removeAttr('style'), v.scrollbar.drag && v.scrollbar.drag.length && v.scrollbar.drag.removeAttr('style'));
